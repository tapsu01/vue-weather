<template>
  <div id="app" :class="typeof weather.main != 'undefined' && weather.main.temp > 16 ? 'warm' : ''">
    <main>
      ...
      <div>
        <a href="#" @click.stop="testWebShare()">Share</a>
      </div>
    </main>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async testWebShare() {
      const shareOpts = {
        title: 'Dấu chân theo năm tháng',
        text: 'MyTravelMap – Bản đồ du lịch in dấu chân của bạn. | GODY.VN',
        url: 'https://gody.vn/thanh-vien/nguyen_tu_7a/du-lich-nuoc-ngoai',
      };
      console.log('shareOpts >> ', shareOpts);
      const { title, text, url } = shareOpts;
